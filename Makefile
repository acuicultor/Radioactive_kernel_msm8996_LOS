...
HOSTCC       = gcc
HOSTCXX      = g++
HOSTCFLAGS   = -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fno-inline-functions -fno-ipa-cp-clone -fomit-frame-pointer -std=gnu89 $(GRAPHITE)
HOSTCXXFLAGS = -O2 -fno-inline-functions -fno-ipa-cp-clone $(GRAPHITE)
